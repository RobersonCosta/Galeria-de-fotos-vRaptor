...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
            <h2 align="center">Adicionando uma galeria</h2>
        </div>
        <div style="width:40%; height:100%; margin: 0 auto; " id="cadastro">
            <form role="form" action="${pageContext.request.contextPath}/galeria/inserir" method="post" class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-2 control-label">Título </label> 
                    <div class="col-sm-10">
                        <input type="text" name="galeria.titulo" class="form-control" placeholder="Título">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Descrição </label>
                    <div class="col-sm-10">
                        <input type="text" name="galeria.descricao" class="form-control" placeholder="Descrição">
                    </div>
                </div>
                <input type="hidden" value="${usuario.id}" name="galeria.usuario.id">
